...
public class MyFlow {
	public static String instance = "task4-Instances/inv1_fail.xmi";
...
//        Venue venue2 = Hw1Factory.eINSTANCE.createVenue(); // object 6
        ...
        customer1.setName("Ava John");
        customer1.setEmail("avaJ@gmail.com");
        customer1.setPhone("412441451");
...
//        customer2.setPhone("5725208652");
        ...
        review1.setRating(6);
        review1.setComment("I loved the food absolutely!");
        review1.setReviewID(65);
...
//        venueVisitBooking.setMenuOptions(menuItems2);	
        ...
        saveModel(instance, customer1,review1);// venue1, venue2, eventBooking, venueVisitBooking, bookingAdmin);
    }
